...
if not found:
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The LatticeFinder program requires the "packaging" program.'+'\n'
	toString += '\n'
	toString += 'Install packaging through pip by following the instruction in https://latticefinder.readthedocs.io/en/latest/Installation.html'+'\n'
