...
from LatticeFinder import __author__
project = u'LatticeFinder: A program for obtaining Lattice Constants'
...
from LatticeFinder import __version__
...
html_logo = None #'Images/cluster.jpg'
...
latex_documents = [
    (master_doc, 'LatticeFinder.tex', u'The LatticeFinder Documentation',
...
man_pages = [
    (master_doc, 'LatticeFinder', u'The LatticeFinder Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LatticeFinder', u'The LatticeFinder Documentation',
     author, 'LatticeFinder', 'This program is designed to obtain the optimum lattice constants and other information about a 3D bulk system (and 2D system).',
     'Research'),
]
